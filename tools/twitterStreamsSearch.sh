...
parametres_tweeter="src=typd&lang=fr"

echo -e "Recherche du mot cle \"\033[31m"$motCle"\033[0m\" dans "POPULAIRE":"

lynx --dump "https://twitter.com/search?q="$motCleFormatte"&source=lnms&"$parametres_tweeter"" > $fichierTemp
